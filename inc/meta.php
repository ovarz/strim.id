...
<link rel="preload" href="img/asset/logo.svg" as="image">
...
<link rel="stylesheet" type="text/css" href="css/rancak-mobile.css?<?php echo $anticache; ?>" media="(max-width:1023px)">
