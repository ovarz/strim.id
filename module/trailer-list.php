<article class="trailer-box">
  ...
  <div class="trailer-box-info">
    ...
    <div class="tbi-gateway">
      <a class="tbi-link" href="javascript:void(0)">
        <div class="tbi-icon content_center">
          <div class="flex_ori"><img class="lazyload" data-original="img/sample/profile-<?php echo rand(1,20); ?>.jpg" /></div>
        </div>
        <div class="tbi-label">Follow</div>
      </a>
      <a class="tbi-link" href="javascript:void(0)">
        <div class="tbi-icon content_center">
