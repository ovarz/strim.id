<a
  ...
  <?php } ?>
  <?php if($stories == 'profile' || $stories == 'strimid') { ?>
...
>
  <div class="stories-thumb <?php if($stories_live == 'yes') { ?>stories-live<?php } ?> content_center">
    ...
    <?php if($stories == 'profile' || $stories == 'strimid') { ?>stories-thumb-image flex_ori thumb-loading<?php } ?>
    content_center">
       <?php if($stories == 'all') { ?>
       ...
       <?php } ?>
       <?php if($stories == 'strimid') { ?>
         <img class="lazyload" data-original="img/profile-strimid.jpg" />
       <?php } ?>
    </div>
  </div>
  <div class="stories-name">
    ...
    <?php if($stories == 'strimid') { ?>Strim.id<?php } ?>
  </div>
</a>